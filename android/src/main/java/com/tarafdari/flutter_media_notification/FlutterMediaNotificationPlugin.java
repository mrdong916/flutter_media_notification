...
public class FlutterMediaNotificationPlugin implements MethodCallHandler {
  ...
  public void onMethodCall(MethodCall call, @NonNull Result result) {
    switch (call.method) {
      case "showNotification":
        ...
        final byte[] cover = call.argument("cover");
        showNotification(title, author, cover, isPlaying);
        result.success(null);
        break;
  ...
  static void showNotification(String title, String author, byte[] cover, boolean play) {
